...
export function FileTile({
  ...
  return (
    <motion.div
      ...
      className="group overflow-hidden rounded-xl border border-g-border bg-white transition-shadow hover:shadow-[0_1px_3px_1px_rgba(60,64,67,.15)]"
    >
      <div className="flex items-center gap-2 px-3 py-2.5">
        <Icon name={icon} size={20} className={color} fill />
        <span className="flex-1 truncate text-sm font-medium text-g-text" title={file.name}>
          {file.name}
        </span>
      ...
      <div className="grid h-32 place-items-center bg-g-hover">
